...
for i = 1:4
    %3
    h1(i)= py.CoolProp.CoolProp.PropsSI('H','T',T1(i),'P',P1(i),'R134a'); %J/kg
    h2(i)=py.CoolProp.CoolProp.PropsSI('H','T',T2(i),'P',P2(i),'R134a'); %J/kg
    h3(i)=py.CoolProp.CoolProp.PropsSI('H','T',T3(i),'P',P3(i),'R134a'); %J/kg
    h4(i)= h3(i); %py.CoolProp.CoolProp.PropsSI('H','T',T4(i),'P',P4(i),'R134a'); %J/kg
    h5(i)=py.CoolProp.CoolProp.PropsSI('H','T',T5(i),'P',P5(i),'R134a'); %J/kg
    %4
    r1(i)=py.CoolProp.CoolProp.PropsSI('D','T',T1(i),'P',P1(i),'R134a'); %kg/m3
    r2(i)=py.CoolProp.CoolProp.PropsSI('D','T',T2(i),'P',P2(i),'R134a');
    r3(i)=py.CoolProp.CoolProp.PropsSI('D','T',T3(i),'P',P3(i),'R134a');
    r4(i)=py.CoolProp.CoolProp.PropsSI('D','T',T3(i),'P',P4(i),'R134a');
    r5(i)=py.CoolProp.CoolProp.PropsSI('D','T',T4(i),'P',P5(i),'R134a');
...
%12
for i = 1:4
    s1(i) = py.CoolProp.CoolProp.PropsSI('S', 'T', T1(i), 'P', P1(i), 'R134a');
    h2s(i) = py.CoolProp.CoolProp.PropsSI('H', 'S', s1(i), 'T', T2(i), 'R134a');
end
%13
etaC = (h2s-h1)./(h2-h1+qloss) * 100;
...
hold on;
maxFlowIdx = 1;
plot(h1(maxFlowIdx)*10^-3, P1(maxFlowIdx)*10^-3, 'ro', 'DisplayName', '1');
plot(h2(maxFlowIdx)*10^-3, P2(maxFlowIdx)*10^-3, 'bo', 'DisplayName', '2');
plot(h3(maxFlowIdx)*10^-3, P3(maxFlowIdx)*10^-3, 'go', 'DisplayName', '3');
plot(h4(maxFlowIdx)*10^-3, P4(maxFlowIdx)*10^-3, 'ko', 'DisplayName', '4');
